...
train_horses = tf.data.TFRecordDataset(os.path.join(dataset_dir, 'trainA.tfrecord'))
train_horses = train_horses.map(parse_tfrecord)

train_zebras = tf.data.TFRecordDataset(os.path.join(dataset_dir, 'trainB.tfrecord'))
train_zebras = train_zebras.map(parse_tfrecord)
